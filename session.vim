...
exe 'vert 2resize ' . ((&columns * 10 + 84) / 168)
exe '3resize ' . ((&lines * 15 + 21) / 43)
exe 'vert 3resize ' . ((&columns * 29 + 84) / 168)
exe '4resize ' . ((&lines * 21 + 21) / 43)
exe 'vert 4resize ' . ((&columns * 29 + 84) / 168)
exe '5resize ' . ((&lines * 37 + 21) / 43)
exe 'vert 5resize ' . ((&columns * 127 + 84) / 168)
argglobal
terminal ++curwin ++cols=168 ++rows=2 
...
exe '2resize ' . ((&lines * 30 + 21) / 43)
tabnext
edit /media/admin/New\ Volume/prog\ stuff\ c\ plu\ plu/pss/styles.pss
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
...
lcd /media/admin/New\ Volume/prog\ stuff\ c\ plu\ plu/pss
tabnext
edit /media/admin/New\ Volume/prog\ stuff\ c\ plu\ plu/pss/notes.txt
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
...
badd +1 /media/admin/New\ Volume/prog\ stuff\ c\ plu\ plu/pss/styles.pss
badd +0 /media/admin/New\ Volume/prog\ stuff\ c\ plu\ plu/pss/notes.txt
